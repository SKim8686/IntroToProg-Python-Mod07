...
#   Sun-Hae Kim,11.27.23, functions, classes, and using the separation of concerns pattern.
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    # TODO Create a getter for the first_name property
    @property
    def first_name(self):
        return self._first_name

    # TODO Create a setter for the first_name property
    @first_name.setter
    def first_name(self, value):
        self._first_name = value

    # TODO Create a getter for the last_name property
    @property
    def last_name(self):
        return self._last_name

    # TODO Create a setter for the last_name property
    @last_name.setter
...
class Student(Person):
    ...
    # TODO add a getter for course_name
    @property
    def course_name(self):
        return self._course_name

    # TODO add a setter for course_name
    @course_name.setter
    ...
    def __str__(self):
        return f'Student {super().__str__()} is enrolled in {self._course_name}'
...
class IO:
    ...
    def output_student_and_course_names(student_data: list):
        ...
        for student in student_data:
            print(Student(first_name=student["FirstName"], last_name=student["LastName"], course_name=student["CourseName"]))
        print("-" * 50)
